# Vivah UX Bible: The Architecture of Trust

This document is the definitive User Experience (UX) blueprint for Vivah. It dictates the psychological, architectural, and interaction principles that separate Vivah from conventional dating applications and legacy matrimonial websites. Our true competitors are not other matrimonial apps—our competitors for attention and trust are Aman Resorts, Apple, and private wealth managers.

---

## 1. User Personas

Vivah serves a diverse but specific demographic. Our design must respect traditional family involvement while empowering modern independence.
...
Every screen in Vivah is designed with extreme intentionality. Below is the blueprint for core screens.
...
- **Information Hierarchy:** 1. Hero Statement (Quiet confidence) 2. "Why Vivah" (Trust pillars) 3. Social Proof (Anonymized success stats).
...
7. **Approval:** Admin approves. User receives a beautifully crafted "Welcome to Vivah" email.
...
- **Scroll Behavior:** On mobile, the Top App Bar (containing the Vivah logo and Notifications bell) hides on scroll down to maximize screen real estate, and instantly reappears on scroll up.

---

## 7. UX Principles (Friction vs. Flow)

At Vivah, **Friction is a feature, not a bug.**
...
- **Copywriting Tone:** Editorial, calm, affirmative. 
  ...
  - *Vivah Standard:* "We were unable to save your changes. Please verify your connection and try again."

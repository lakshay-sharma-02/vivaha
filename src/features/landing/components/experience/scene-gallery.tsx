...
export function SceneGallery({ progress, rawProgress }: { progress: MotionValue<number>; rawProgress: MotionValue<number> }) {
  ...
  return (
    <motion.div style={{ opacity: galleryOpacity, scale: galleryScale, willChange: "transform, opacity" }} className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
      ...
      <motion.div style={{ y: shiftY1, willChange: "transform" }} className="absolute left-[-10%] md:left-[10%] top-[20%] w-40 md:w-48 h-56 md:h-64 glass rounded-3xl p-2 border-white/5 shadow-xl rotate-[-10deg]">
      ...
      <motion.div style={{ y: shiftY2, willChange: "transform" }} className="absolute right-[-10%] md:right-[15%] top-[15%] w-48 md:w-56 h-64 md:h-72 glass rounded-3xl p-2 border-white/5 shadow-xl rotate-[5deg]">
      ...
      <motion.div style={{ y: shiftY3, willChange: "transform" }} className="absolute left-[5%] md:left-[20%] bottom-[20%] w-56 md:w-64 h-72 md:h-80 glass rounded-3xl p-2 border-white/5 shadow-xl rotate-[12deg]">
      ...
      <motion.div style={{ y: shiftY4, willChange: "transform" }} className="absolute right-[5%] md:right-[25%] bottom-[15%] w-48 md:w-52 h-56 md:h-64 glass rounded-3xl p-2 border-white/5 shadow-xl rotate-[-8deg]">

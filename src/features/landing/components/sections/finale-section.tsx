...
import { useSmartInView, scaleIn, fadeInUp } from "@/shared/animations"
...
export function FinaleSection() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-500/10 via-black to-black opacity-40" />

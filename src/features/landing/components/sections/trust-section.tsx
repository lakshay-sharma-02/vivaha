...
export function TrustSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black text-white py-20"
    >
      <motion.div
      ...
      >
        ...
        <h2 className="mt-12 font-playfair text-4xl md:text-6xl font-light text-zinc-300 tracking-wide text-center">
          Absolute Secrecy
        </h2>

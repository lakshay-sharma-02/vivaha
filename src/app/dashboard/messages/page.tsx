...
const CONVERSATIONS = [
  {
    ...
    lastMessage: "I'd love to know more about your travels in Italy.",
    time: "10:42 AM",
    unread: 2,
    online: true,
    compatibility: 94,
    ...
    verified: true,
    messages: [
      { id: 1, sender: "me", text: "Hi Sneha, it's wonderful to connect. I noticed we both share a passion for renaissance art.", time: "10:30 AM", status: "read" },
      { id: 2, sender: "them", text: "Hello! Yes, absolutely. I spent a summer in Florence studying architecture.", time: "10:35 AM" },
      { id: 3, sender: "them", text: "I'd love to know more about your travels in Italy.", time: "10:42 AM" }
    ]
  },
  {
    id: 2,
    ...
    lastMessage: "That sounds like a wonderful plan.",
    time: "Yesterday",
    unread: 0,
    online: false,
    compatibility: 89,
    ...
    verified: true,
    messages: [
      { id: 1, sender: "them", text: "Thank you for the recommendation.", time: "Yesterday" },
      { id: 2, sender: "me", text: "You're welcome. We should visit the new gallery opening this weekend.", time: "Yesterday", status: "read" },
      { id: 3, sender: "them", text: "That sounds like a wonderful plan.", time: "Yesterday" }
    ]
  }
];
          ...
          <>
            ...
            <div className="p-6 bg-[#FBF9F6]/80 backdrop-blur-md border-t border-[#E6D5C3]/40 shrink-0">
              <div className="bg-white border border-[#E6D5C3] rounded-3xl p-2 flex items-center shadow-inner">
                ...
                <button className="w-10 h-10 ml-2 rounded-full bg-[#2A2621] flex items-center justify-center text-white hover:bg-[#1A1815] transition-colors shadow-md">

...
The Footer concludes the Vivah experience gracefully.
...
Simply reinforce why Vivah exists.
...
Highlight the principles that define Vivah.
...
Vivah should not aggressively collect emails.
...
*Vivah should end every journey with the same care with which it begins."*
